...
class Ui_TwitterAndNews(object):
    def setupUi(self, TwitterAndNews):
        ...
        TwitterAndNews.resize(1220, 690)
        ...
        self.gridLayout_7.addLayout(self.gridLayout_5, 3, 2, 1, 3)
        ...
        self.Search_bt_tw.setMinimumSize(QtCore.QSize(200, 0))
        self.Search_bt_tw.setObjectName("Search_bt_tw")
        self.horizontalLayout.addWidget(self.Search_bt_tw)
        self.Search_bt_news = QtWidgets.QPushButton(self.centralwidget)
        self.Search_bt_news.setMinimumSize(QtCore.QSize(200, 0))
        self.Search_bt_news.setObjectName("Search_bt_news")
        self.horizontalLayout.addWidget(self.Search_bt_news)
        ...
        self.gridLayout.addWidget(self.progressBar_tw, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.progressBar_news, 4, 1, 1, 1)
        self.gridLayout_7.addLayout(self.gridLayout, 0, 1, 1, 2)
        ...
        self.gridLayout_7.addLayout(self.gridLayout_6, 3, 0, 1, 2)
        ...
        self.gridLayout_7.addLayout(self.gridLayout_2, 2, 0, 1, 5)
